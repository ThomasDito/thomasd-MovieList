...
const MovieHome = () => {
    ...
    // hooks untuk call function API dari modul Api, jalanin saat pertama kali page di render
    // useEffect(() => {
    ...
    // bisa juga dengan cara ini untuk call function API, menggunakan async/await cara yang lebih modern dan best practice
    // useEffect(() => {
    ...
    return (
        <div className="container mx-auto pt-32 sm:pt-36" ref={homeRef}>
            <NavbarProd />
            <div className="page-info flex gap-2 max-w-11/12 mx-auto justify-center sm:justify-start mt-4 sm:ml-18 md:ml-20 lg:ml-22 xl:ml-24 2xl:ml-26">
